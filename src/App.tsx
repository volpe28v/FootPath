    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          {/* ネオン風ローディングテキスト */}
          <div className="text-4xl font-mono font-bold text-cyan-400 mb-6 animate-pulse"
               style={{
          ...
          <div className="w-64 h-1 bg-slate-700 rounded-full overflow-hidden">
            <div className="h-full bg-gradient-to-r from-cyan-400 to-cyan-300 rounded-full animate-pulse"
                 style={{
          ...
          <div className="flex justify-center gap-2 mt-6">
            <div className="w-2 h-2 bg-cyan-400 rounded-full animate-ping" style={{animationDelay: '0s'}}></div>
    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          <h1 className="text-6xl font-bold mb-6 font-mono text-cyan-400"
              style={{
                textShadow: '0 0 10px #00ffff, 0 0 20px #00ffff, 0 0 30px #00ffff',
                lineHeight: '1.3'
              }}>
          ...
          <div className="text-cyan-400 text-lg font-mono mb-12 tracking-wider"
               style={{
